...
public class TwitterServiceIntTest {
    ...
    public void firstPostTweetFailureLongText() {
        String longText = "This is a test case, must be longer than 140 characters. I am trying to think of things to say that are longer than 140 characters. Have I succeeded? Need to come up with longer text so I will keep going until no one stops me. Nobody can stop me. ";
        Double lon = 1.0;
        Double lat = -1.0;
