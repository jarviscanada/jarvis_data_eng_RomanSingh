...
insert_stmt="INSERT INTO host_usage(hostname, memory_free, cpu_idle, cpu_kernel, disk_io, disk_available, timestamp)
VALUES('$hostname', '$memory_free', '$cpu_idle', '$cpu_kernel', '$disk_io', '$disk_available', '$timestamp')"
